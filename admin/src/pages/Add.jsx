...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        <p>Description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write detail here' required/>
      </div>
      ...
      <div className='flex gap-2 mt-2'>
        ...
        <label className='cursor-pointer' htmlFor="checkbox">Add to bestseller</label>
      </div>
